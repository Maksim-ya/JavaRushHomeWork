...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer,Contact {
       ...
       private  IncomeData incomeData;
        ...
        {
            String number =  this.incomeData.getPhoneNumber()+"";
            String nulls = "";
            if (number.length()<10)
            {
                ...
                String third = number.substring(6,8);
                String fourth = number.substring(8);

            return "+"+this.incomeData.getCountryPhoneCode()+"("+first+")"+second+"-"+third+"-"+fourth;
        }
